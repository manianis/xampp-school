...
begin
    ...
    WebRootTrayControl.Visible := bApacheWebRoot.Enabled;
    htdocsFolderTrayControl.Visible := bApacheHtdocsFolder.Enabled;
    phpMyAdminTrayControl.Visible := bMySQLAdmin.Enabled;
    ExportDatabaseTrayControl.Visible := bMySQLDump.Enabled;
end;
